...
def parse_args():
    ...
    # parser.add_argument('--datasets_root', type=str, default='/data4/luzeng/datasets', help='dataset_name')
    # parser.add_argument('--dataset', type=str, default='dsn', help='dataset_name')

    parser.add_argument('--datasets_root', type=str, default='./dataset', help='dataset_name')
    parser.add_argument('--dataset', type=str, default='ffhq_256', help='dataset_name')
    ...
    parser.add_argument('--id_loss_weight', type=int, default=10, help='Weight for id loss to bind generator')
    ...
    parser.add_argument('--result_dir', type=str, default='results/add_id_loss', help='Directory name to save the results')
